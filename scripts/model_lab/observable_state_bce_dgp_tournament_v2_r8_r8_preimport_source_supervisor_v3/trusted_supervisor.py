"""Stdlib-only full-runtime pre-import supervisor for the fixed R8-r8 freezer.
...
MANIFEST_RAW_SHA256 = "09848b168eb261fd0b6e3de8944ef2c96cb314e33f2b0ae92b26066e533215c9"
MANIFEST_SIZE_BYTES = 5612
STUB_TEMPLATE_RAW_SHA256 = "c1be8402881be09fa4365016983c6253da9d77e93cd4a35db53a4d7bc0dd49c1"
STUB_TEMPLATE_SIZE_BYTES = 8092
STUB_TEMPLATE_VOLUME_SERIAL_NUMBER = 13325047249941796650
STUB_TEMPLATE_FILE_ID_128 = "dfa4200000002c000000000000000000"
...
def _open_no_share_write_delete(path: Path, *, directory: bool, create_child: bool = False) -> int:
...
def _directory_inventory(path: Path) -> tuple[list[Any], ...]:
    ...
    for entry in entries:
        ...
        handle = _open_no_share_write_delete(child, directory=kind == "directory")
        try:
...
def _hold_fixed_closure(owner: _CheckedOwners) -> tuple[tuple[_HeldFile, ...], Mapping[str, Any]]:
    ...
    if (
        ...
        != "expected_pe.r8.r8.preimport_source_supervisor.closure_manifest.v3"
...
def main() -> int:
    ...
    try:
        ...
        receipt = {
            "schema_version": "expected_pe.r8.r8.preimport_source_supervisor.receipt.v3",
            "status": (
