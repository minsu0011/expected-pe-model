"""One-shot DACL seal for the independently audited managed bootstrap V1."""
...
EXECUTABLE_SHA256 = "8adde3b985523bdd4e389bae8340c783bb6d29a69ef7eb7fac5ab63448ee43b1"
EXECUTABLE_SIZE = 33280
EXECUTABLE_VOLUME = 13325047249941796650
EXECUTABLE_FILE_ID = "0ea5200000003e000000000000000000"
RECEIPT = PROJECT_ROOT / (
    "outputs/r8r8_native_prebootstrap_v1_immutable_seal_receipt_20260823.json"
)
EXACT_ARGUMENT = "--seal-fixed-native-prebootstrap-v1-owner-rights-read-execute-once"
ZERO_COUNTS = {
    "authority": 0,
    "fresh": 0,
    "generation": 0,
...
def _load_supervisor() -> Any:
    ...
    if (
        ...
        raise RuntimeError("V3 supervisor drifted before native seal")
    spec = importlib.util.spec_from_file_location("native_v1_seal_v3", SUPERVISOR)
...
def main(arguments: list[str]) -> int:
    ...
    try:
        ...
        receipt = {
            ...
            "schema_version": "expected_pe.r8.r8.native_prebootstrap.immutable_seal.v1",
