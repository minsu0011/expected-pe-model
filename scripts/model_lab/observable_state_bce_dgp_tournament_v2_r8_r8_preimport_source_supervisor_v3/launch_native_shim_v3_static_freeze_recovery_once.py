"""Lossless recovery launcher for sealed shim V3 and supervisor V5."""
...
SHIM_SHA256 = "b3e5637005afe3404c4b417046c27ab970fd82a45d548d185d1dd718bda655e1"
SHIM_SIZE = 80896
SHIM_ARGUMENT = "--execute-fixed-r8-r8-static-once-no-authority"
EXACT_ARGUMENT = "--launch-sealed-native-shim-v3-static-freeze-v5-recovery-once-lossless-capture"
STDOUT_CAPTURE = PROJECT_ROOT / (
    "outputs/r8r8_native_chain_v3_recovery_actual_stdout_20260823.jsonl"
)
STDERR_CAPTURE = PROJECT_ROOT / (
    "outputs/r8r8_native_chain_v3_recovery_actual_stderr_20260823.bin"
)
LAUNCH_RECEIPT = PROJECT_ROOT / (
    "outputs/r8r8_native_chain_v3_recovery_actual_launch_receipt_20260823.json"
)
SUPERVISOR_CLAIM = (
...
def main(arguments: list[str]) -> int:
    ...
    terminal = {
        ...
        "schema_version": "expected_pe.r8.r8.native_chain.lossless_launch_receipt.v3",
        "shim_file_id_contract": "5a0f210000000e000000000000000000",
    ...
    success = (
        ...
        == "PASS_PREPYTHON_FILE_DACL_CUSTODY_AND_FIXED_V5_CHILD_NO_AUTHORITY"
