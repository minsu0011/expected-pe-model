"""V4 recovery supervisor for the fixed R8-r8 freezer.
...
SUPERVISOR_PATH = SCRIPT_ROOT / "trusted_supervisor_v4.py"
MANIFEST_PATH = SCRIPT_ROOT / "SOURCE_CLOSURE_MANIFEST_V4.json"
STUB_TEMPLATE_PATH = SCRIPT_ROOT / "STDLIB_LAUNCH_STUB_TEMPLATE_V4.txt"
RUNTIME_CLOSURE_PATH = SCRIPT_ROOT / "STATIC_CHILD_RUNTIME_CLOSURE.json"
MANIFEST_RAW_SHA256 = "c4ab727356765c698dcdcbc4ac669780c52f6a2888b92c7a3e122be341d5a21f"
MANIFEST_SIZE_BYTES = 5615
STUB_TEMPLATE_RAW_SHA256 = "a28e1819f29d90d716c5640cc87df85218a190895fc1e9e3260eaeec2fb738e4"
STUB_TEMPLATE_SIZE_BYTES = 8096
STUB_TEMPLATE_VOLUME_SERIAL_NUMBER = 13325047249941796650
STUB_TEMPLATE_FILE_ID_128 = "72a52000000028000000000000000000"
...
SUPERVISOR_CLAIM_PREFIX = (
    PROJECT_ROOT
    / "build"
    / ("pc_r8r8_preimport_source_supervisor_v4_recovery_once_20260823")
)
...
def _hold_fixed_closure(owner: _CheckedOwners) -> tuple[tuple[_HeldFile, ...], Mapping[str, Any]]:
    ...
    if (
        ...
        != "expected_pe.r8.r8.preimport_source_supervisor.closure_manifest.v4"
...
def main() -> int:
    ...
    try:
        ...
        receipt = {
            "schema_version": "expected_pe.r8.r8.preimport_source_supervisor.receipt.v4",
            "status": (
...
if __name__ == "__main__":
    if "_STUB_SOURCE_HANDLE" not in globals():
        raise SystemExit("DENIED_DIRECT_PATH_INVOCATION_REQUIRES_AUDITED_STDLIB_C_STUB_V4")
