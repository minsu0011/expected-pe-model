"""Lossless recovery launcher for sealed shim V2 and supervisor V4."""
...
SHIM = PROJECT_ROOT / (
    "build/r8r8_native_environment_shim_v2_immutable_20260823/ExpectedPeNativeEnvironmentShimV2.exe"
)
SHIM_SHA256 = "b832541b6bf3463d90e294608167f5f16158d47a22c0b4fb2d25da6af20189d2"
SHIM_SIZE = 80896
SHIM_ARGUMENT = "--execute-fixed-r8-r8-static-once-no-authority"
EXACT_ARGUMENT = "--launch-sealed-native-shim-v2-static-freeze-v4-recovery-once-lossless-capture"
STDOUT_CAPTURE = PROJECT_ROOT / (
    "outputs/r8r8_native_chain_v2_recovery_actual_stdout_20260823.jsonl"
)
STDERR_CAPTURE = PROJECT_ROOT / (
    "outputs/r8r8_native_chain_v2_recovery_actual_stderr_20260823.bin"
)
LAUNCH_RECEIPT = PROJECT_ROOT / (
    "outputs/r8r8_native_chain_v2_recovery_actual_launch_receipt_20260823.json"
)
SUPERVISOR_CLAIM = (
    PROJECT_ROOT / "build/pc_r8r8_preimport_source_supervisor_v4_recovery_once_20260823"
)
...
def main(arguments: list[str]) -> int:
    ...
    terminal = {
        ...
        "schema_version": "expected_pe.r8.r8.native_chain.lossless_launch_receipt.v2",
        "shim_file_id_contract": "360f2100000011000000000000000000",
    ...
    success = (
        ...
        == "PASS_PREPYTHON_FILE_DACL_CUSTODY_AND_FIXED_V4_CHILD_NO_AUTHORITY"
