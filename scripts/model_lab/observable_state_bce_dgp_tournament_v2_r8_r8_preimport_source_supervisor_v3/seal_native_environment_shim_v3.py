"""One-shot DACL seal for the fixed native environment shim V3."""
...
EXECUTABLE = PROJECT_ROOT / (
    "build/r8r8_native_environment_shim_v3_immutable_20260823/ExpectedPeNativeEnvironmentShimV3.exe"
)
EXECUTABLE_SHA256 = "b3e5637005afe3404c4b417046c27ab970fd82a45d548d185d1dd718bda655e1"
EXECUTABLE_SIZE = 80896
EXECUTABLE_VOLUME = 13325047249941796650
EXECUTABLE_FILE_ID = "5a0f210000000e000000000000000000"
RECEIPT = PROJECT_ROOT / (
    "outputs/r8r8_native_environment_shim_v3_immutable_seal_receipt_20260823.json"
)
EXACT_ARGUMENT = "--seal-fixed-native-environment-shim-v3-owner-rights-read-execute-once"
ZERO_COUNTS = {
    "authority": 0,
    "fresh": 0,
    "generation": 0,
...
def _load_supervisor() -> Any:
    ...
    if (
        ...
        raise RuntimeError("V5 supervisor drifted before native shim seal")
    spec = importlib.util.spec_from_file_location("native_shim_v3_seal_v5", SUPERVISOR)
...
def main(arguments: list[str]) -> int:
    ...
    try:
        ...
        receipt = {
            ...
            "schema_version": "expected_pe.r8.r8.native_environment_shim.immutable_seal.v3",
