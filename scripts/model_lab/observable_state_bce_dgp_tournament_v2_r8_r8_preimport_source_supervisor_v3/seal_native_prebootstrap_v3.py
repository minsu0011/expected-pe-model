"""One-shot DACL seal for the independently audited managed bootstrap V3."""
...
SUPERVISOR = Path(__file__).resolve().parent / "trusted_supervisor_v5.py"
EXECUTABLE = PROJECT_ROOT / (
    "build/r8r8_native_prebootstrap_v3_immutable_20260823/ExpectedPeNativePrebootstrapV3.exe"
)
EXECUTABLE_SHA256 = "2e265bc7e57b401e3c96debf87ef9f766ae14d43ed7f096dcfa852e03dea49eb"
EXECUTABLE_SIZE = 33280
EXECUTABLE_VOLUME = 13325047249941796650
EXECUTABLE_FILE_ID = "4f0f210000000d000000000000000000"
RECEIPT = PROJECT_ROOT / (
    "outputs/r8r8_native_prebootstrap_v3_immutable_seal_receipt_20260823.json"
)
EXACT_ARGUMENT = "--seal-fixed-native-prebootstrap-v3-owner-rights-read-execute-once"
ZERO_COUNTS = {
    "authority": 0,
    "fresh": 0,
    "generation": 0,
...
def _load_supervisor() -> Any:
    ...
    if (
        ...
        != "2166d35962260d0efaaf8a77845f4531d5393f74bcfe5cbcba1194f84b3de6ba"
    ):
        raise RuntimeError("V5 supervisor drifted before native seal")
    spec = importlib.util.spec_from_file_location("native_v3_seal_v5", SUPERVISOR)
    if spec is None or spec.loader is None:
        raise RuntimeError("V5 supervisor loader is unavailable")
...
def main(arguments: list[str]) -> int:
    ...
    try:
        ...
        receipt = {
            ...
            "schema_version": "expected_pe.r8.r8.native_prebootstrap.immutable_seal.v3",
