"""One-shot DACL seal for the fixed native environment shim V2."""
...
EXECUTABLE_SHA256 = "b832541b6bf3463d90e294608167f5f16158d47a22c0b4fb2d25da6af20189d2"
EXECUTABLE_SIZE = 80896
EXECUTABLE_VOLUME = 13325047249941796650
EXECUTABLE_FILE_ID = "360f2100000011000000000000000000"
RECEIPT = PROJECT_ROOT / (
    "outputs/r8r8_native_environment_shim_v2_immutable_seal_receipt_20260823.json"
)
EXACT_ARGUMENT = "--seal-fixed-native-environment-shim-v2-owner-rights-read-execute-once"
ZERO_COUNTS = {
    "authority": 0,
    "fresh": 0,
    "generation": 0,
...
def _load_supervisor() -> Any:
    ...
    if (
        ...
        raise RuntimeError("V4 supervisor drifted before native shim seal")
    spec = importlib.util.spec_from_file_location("native_shim_v2_seal_v4", SUPERVISOR)
...
def main(arguments: list[str]) -> int:
    ...
    try:
        ...
        receipt = {
            ...
            "schema_version": "expected_pe.r8.r8.native_environment_shim.immutable_seal.v2",
