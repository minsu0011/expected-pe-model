"""Isolated child dispatcher for the R8-r12 qualification-only execution identity."""
...
def dispatch(args: argparse.Namespace) -> int:
    ...
    if command == "role-protected-check":
        from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_r12_qualification_execution_v1.protected_role import (  # noqa: E501
            check_only,
        )
    ...
    if command == "role-public-check":
        root = PROJECT_ROOT / "outputs" / (
            "model_zoo_observable_state_bce_dgp_tournament_v2_r8_r12_"
            "qualification_generation_check_only_probe"
        )
        _public_guard(root)
        _require_public_namespace()
        from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_r12_qualification_execution_v1.public_role import (  # noqa: E501
            check_only,
        )
    ...
    if command == "role-public-finalize-check":
        ...
        _public_guard(root)
        _require_public_namespace()
        from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_r12_qualification_execution_v1.controller import (  # noqa: E501
