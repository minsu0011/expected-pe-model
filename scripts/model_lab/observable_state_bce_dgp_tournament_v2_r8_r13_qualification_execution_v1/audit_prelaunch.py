"""Independent mechanical prelaunch audit for the R8-r13 execution revision."""
...
TEST_RELATIVE = (
    "tests/model_lab/test_observable_state_bce_dgp_tournament_v2_r8_r13_"
...
PYCACHE_CHILD = "pc_r8r13_prelaunch_audit_v1_20260823"
...
def _write_tree(root: Path, files: dict[str, bytes]) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="r8r13_prelaunch_audit_", dir=PROJECT_ROOT / "build") as text:
...
def main() -> int:
    ...
    check = _check_only()
    source_manifest = {
        "schema_version": "expected_pe.r8.r13.prelaunch_source_manifest.v1",
    ...
    audit = {
        "schema_version": "expected_pe.r8.r13.qualification_prelaunch_audit.v1",
