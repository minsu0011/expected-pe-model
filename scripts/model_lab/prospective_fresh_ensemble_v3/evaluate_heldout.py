...
from research.model_zoo.prospective_fresh_ensemble_v3.contracts import DEFAULT_OUTPUT_NAME  # noqa: E402
from research.model_zoo.prospective_fresh_ensemble_v3.evaluation import (  # noqa: E402
    write_heldout_report_and_terminal,
)
from research.model_zoo.prospective_fresh_ensemble_v3.heldout_process import (  # noqa: E402
    spawn_heldout_worker,
)
from research.model_zoo.prospective_fresh_ensemble_v3.process_runner import (  # noqa: E402
...
def main() -> int:
    ...
    if args.mode == "_child":
        if args.descriptor is None or args.invocation_id is None or args.stage != "heldout":
            raise RuntimeError("internal heldout evaluator handshake is incomplete")
        if args.worker_kind != "evaluate":
            raise RuntimeError("heldout evaluator rejects this worker kind")
