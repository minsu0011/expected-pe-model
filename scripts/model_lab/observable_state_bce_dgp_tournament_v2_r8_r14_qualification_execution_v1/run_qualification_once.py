"""Consume the R8-r14 qualification identity exactly once after prelaunch GO."""
...
EVIDENCE_ROOT = PROJECT_ROOT / (
    "outputs/model_zoo_r8_r14_qualification_execution_v1_actual_once_20260823"
)
PUBLIC_RUN_ID = "20260824T000005"
...
PYCACHE_CHILD = "pc_r8r14_qualification_actual_once_v1_20260823"
...
def main() -> int:
    ...
    from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_r14_qualification_execution_v1.authority import (  # noqa: E501
    ...
    write_new(
        ...
        {
            "schema_version": "expected_pe.r8.r14.qualification_generation_claim.v1",
    ...
    try:
        ...
        write_new(
            "FINAL_STATUS.json",
            {
                "schema_version": "expected_pe.r8.r14.qualification_execution_status.v1",
        ...
        write_new(
            ...
            {
                "schema_version": "expected_pe.r8.r14.qualification_execution_failure.v1",
