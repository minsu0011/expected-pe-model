"""Append the frozen V4 5+5 reservation without revealing heldout IDs."""
...
from research.model_zoo.prospective_fresh_ensemble_v4.seed_reservation import (  # noqa: E402
...
def main() -> int:
    ...
    print(f"V4_RESERVED {receipt['reservation_id']}")
    print(
        "QUALIFICATION_SEEDS "
    ...
    print("RESERVATION_COMMAND_DATA_OR_MODEL_RUN False")
