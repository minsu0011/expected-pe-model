"""Consume the R8-r9 qualification identity exactly once after prelaunch GO."""
...
AUDIT_ROOT = PROJECT_ROOT / (
    "outputs/model_zoo_r8_r10_qualification_execution_v1_prelaunch_audit_go_20260823"
)
EVIDENCE_ROOT = PROJECT_ROOT / (
    "outputs/model_zoo_r8_r10_qualification_execution_v1_actual_once_20260823"
)
PUBLIC_RUN_ID = "20260824T000001"
...
MARKER_ROOT = PROJECT_ROOT / (
    "outputs/model_zoo_observable_state_bce_dgp_tournament_v2_r8_r8_"
    "qualification_activation_20260822"
)
PYCACHE_CHILD = "pc_r8r10_qualification_actual_once_v1_20260823"
...
def verify_audit() -> tuple[dict[str, Any], str]:
    ...
    if (
        ...
        or audit.get("source_record_count") != 13
    ):
...
def main() -> int:
    ...
    from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_r9_qualification_execution_v1.authority import (  # noqa: E501
        DESIGN_CHECKSUMS_RAW_SHA256,
        RUNTIME_LOCK_SEMANTIC_SHA256,
        SOURCE_LOCK_RAW_SHA256,
        MemoryQualificationAuthority,
    )
    from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_r9_qualification_execution_v1.custodian import (  # noqa: E501
        bind_held_no_bytecode_window,
        run_qualification,
    )
    from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_r9_qualification_execution_v1.no_bytecode import (  # noqa: E501
    ...
    write_new(
        ...
        {
            "schema_version": "expected_pe.r8.r10.qualification_generation_claim.v1",
    ...
    try:
        ...
        write_new(
            "FINAL_STATUS.json",
            {
                "schema_version": "expected_pe.r8.r10.qualification_execution_status.v1",
        ...
        write_new(
            ...
            {
                "schema_version": "expected_pe.r8.r10.qualification_execution_failure.v1",
