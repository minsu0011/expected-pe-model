...
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.contracts import (  # noqa: E402
    AUDITOR_KEY_ID,
...
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.authority import (  # noqa: E402
    verify_ed25519,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.resource import (  # noqa: E402
    memory_status_gib,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.publication import (  # noqa: E402
    durably_fsync_tree,
    fsync_directory,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.runtime_tcb import (  # noqa: E402
    capture_runtime_tcb,
    verify_complete_runtime_tcb,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.scheduler import (  # noqa: E402
    admit_scheduler,
    benchmark_isolated_children,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.source_custody import (  # noqa: E402
    capture_source_lock,
...
RUNTIME_STARTUP_PROBE_RELATIVE = (
    "scripts/model_lab/observable_state_bce_dgp_tournament_v2_"
    "r8_qualification_generation/runtime_startup_probe.py"
)
...
def _quality_receipt() -> Mapping[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="r8_quality_") as temporary_text:
        ...
        pytest_command = [
            ...
            (
                "scripts.model_lab.observable_state_bce_dgp_tournament_v2_"
                "r8_qualification_generation.pytest_receipt_plugin"
            ),
            *tests,
        ]
...
def _runtime_startup_preflight(
    ...
    return {
        "schema_version": "expected_pe.r8.r4.runtime_startup_preflight_receipt.v1",
...
def main() -> int:
    ...
    finding_matrix = {
        "schema_version": "expected_pe.r8.r4.r7_finding_closure_matrix.v1",
        ...
        "closures": [
            {
                "id": "P0-001",
                "implementation": (
                    "one exact-key Ed25519-signed activation bound to audit/design/source/runtime/"
                    "registry/run-id; exact Win32 anonymous inherited-handle object allowlist "
    ...
    authority_state = {
        "schema_version": "expected_pe.r8.r4.qualification.authority_state.v1",
        ...
        "r4_revision_only": True,
    }
    _write(staging / "AUTHORITY_STATE.json", _sealed(authority_state))

    process_contract = {
        "schema_version": "expected_pe.r8.r4.process_isolation_contract.v1",
        "status": "FROZEN_NO_CALLER_ACCESSIBLE_PRIVATE_ROLE_DISPATCH",
        "top_level_cli_arguments": ["--authority", "--run-id"],
        "activation_token_transport": "STDIN_EXACT_64_LOWERCASE_HEX",
    ...
    design_lock = {
        "schema_version": "expected_pe.r8.r4.qualification.design_lock.v1",
    ...
    manifest = {
        "schema_version": "expected_pe.r8.r4.qualification.design_manifest.v1",
    ...
    report = (
        "# DGP Qualification Generation R8-r4 Repair Design\n\n"
        "Status: FROZEN_SCORE_FREE_PRE_GENERATION_PENDING_INDEPENDENT_AUDIT.\n\n"
        "R8-r4 supersedes the preserved immutable R8-r1, R8-r2, and R8-r3 failed self-audits. "
        ...
        "suite exposed an unsealed conda DLL extension origin (`_bz2.pyd`). R8-r4 binds and "
        ...
        "It binds one exact-key Ed25519 authority, strict four-path custody, a complete "
        ...
        "A new clean independent audit must produce a signed zero-finding authority before the "
        "single top-level activation can be used.\n"
    ).encode("utf-8")
    ...
    anchor = {
        "schema_version": "expected_pe.r8.r4.external_launcher_anchor.v1",
    ...
    result = {
        "status": "FROZEN_R8_R4_SCORE_FREE_DESIGN",
