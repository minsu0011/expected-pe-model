"""Run the locked cheap-fold candidate screen after explicit heavy-fit approval."""
...
from research.model_zoo.probabilistic_exploration_v2.runner import (  # noqa: E402
    publish_candidate_predictions,
    run_locked_cheap_candidates,
)
...
def main() -> int:
    args = parse_args()
    predictions, bridge, receipt = run_locked_cheap_candidates(
        repo_root=ROOT,
