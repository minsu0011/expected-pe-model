"""Freeze the superseding V2 source/design/custody precommit; never run data or models."""
...
from research.model_zoo.prospective_fresh_ensemble_v2.precommit import (  # noqa: E402
    DEFAULT_OUTPUT_NAME,
    freeze_precommit,
)
...
def main() -> int:
    ...
    print(f"V2_PRECOMMIT_FROZEN {manifest['manifest_sha256']}")
