...
from research.model_zoo.prospective_fresh_ensemble_v2.qualification_process import (  # noqa: E402
...
def main() -> int:
    ...
    if args.mode == "_child":
        if args.capability is None:
            raise RuntimeError("internal qualification evaluator capability is required")
