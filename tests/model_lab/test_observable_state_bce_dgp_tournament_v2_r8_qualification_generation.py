...
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation import (
    capability,
    publication,
    vault_finalizer,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.authority import (
    AUTHORITY_KEYS,
    authenticate_authority,
    authority_signing_bytes,
    verify_ed25519,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.capability import (
    CAPABILITY_ENV,
    SECURITY_ATTRIBUTES,
    _build_capability,
...
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.contracts import (
    AUDITOR_KEY_ID,
...
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.paths import (
    plan_paths,
    validate_initial_plan,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.publication import (
    PublicationJournal,
    durably_fsync_tree,
    exact_tree_metadata,
    exact_tree_sha256,
...
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.scheduler import (
    TaskSpec,
    admit_scheduler,
    canonical_task_specs,
    run_deterministic_bounded,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_qualification_generation.source_custody import (
    capture_source_lock,
...
PACKAGE = PROJECT_ROOT / (
    "research/model_zoo/observable_state_bce_dgp_tournament_v2_r8_qualification_generation"
)
SCRIPT = PROJECT_ROOT / (
    "scripts/model_lab/observable_state_bce_dgp_tournament_v2_r8_qualification_generation"
)
RUN_ID = "20260821T120000"
TOKEN = "ab" * 32
CAPABILITY_SECRETS = {
    identity: sha256_bytes(f"R8-R4-FIXTURE-SECRET:{identity}".encode("ascii"))
...
def _fixture_authority() -> tuple[dict[str, object], str, str]:
    ...
    payload: dict[str, object] = {
        ...
        "audit_root_relative": (
            ...
            "independent_qualification_pre_generation_audit_fixture"
        ),
        "audit_json_raw_sha256": "1" * 64,
        "audit_seal_raw_sha256": "2" * 64,
        "audit_signer_key_id": key_id,
