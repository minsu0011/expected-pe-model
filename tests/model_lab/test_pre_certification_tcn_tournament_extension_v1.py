...
from research.model_zoo.pre_certification_tcn_tournament_extension_v1.comparators import (
    assert_exact_normalized_join,
)
from research.model_zoo.pre_certification_tcn_tournament_extension_v1.contracts import (
    DESIGN_STATUS,
...
from research.model_zoo.pre_certification_tcn_tournament_extension_v1.prediction_validation import (
    _verify_checksum_ledger,
    normalize_tcn_predictions,
    validate_binding_round_trip,
)
from research.model_zoo.pre_certification_tcn_tournament_extension_v1.path_guards import (
    assert_regular_descendant,
)
from research.model_zoo.pre_certification_tcn_tournament_extension_v1.profile_evidence import (
    verify_frozen_sharded_profile,
)
from research.model_zoo.pre_certification_tcn_tournament_extension_v1.scoring import (
    compute_full_metrics,
)
from research.model_zoo.pre_certification_tcn_tournament_extension_v1.shard_invariants import (
    EXPECTED_SHARD_IDS,
...
def test_hash_profile_placeholder_or_mixed_binding_is_rejected() -> None:
    base = {
        "schema_version": "expected_pe.tcn_tournament_input_binding.v1",
...
def test_original_candidate_and_ancestor_reparse_are_rejected(
    ...
    import research.model_zoo.pre_certification_tcn_tournament_extension_v1.path_guards as guards
...
def test_truth_free_validator_module_has_no_spent_loader_or_outcome_root() -> None:
    ...
    source = (
        project
        / "research/model_zoo/pre_certification_tcn_tournament_extension_v1/"
...
def test_extension_sources_contain_no_reserved_qualification_or_heldout_seed_literals() -> None:
    project = Path(__file__).resolve().parents[2]
    package = project / "research/model_zoo/pre_certification_tcn_tournament_extension_v1"
    integer_literals = {
        node.value
