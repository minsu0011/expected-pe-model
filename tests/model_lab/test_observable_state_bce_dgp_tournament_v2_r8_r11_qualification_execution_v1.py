...
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_r11_qualification_execution_v1.authority import (
    DGPS,
    QUALIFICATION_SEEDS,
    MemoryQualificationAuthority,
    QualificationAuthorityError,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_r11_qualification_execution_v1.protected_role import (
    _logical_frame_sha256 as protected_pre_serialization_digest,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_r11_qualification_execution_v1.protected_role import (
    _public_round_trip_logical_sha256,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_r11_qualification_execution_v1.public_role import (
    _logical_frame_sha256 as public_reconstructed_digest,
)
from research.model_zoo.observable_state_bce_dgp_tournament_v2_r8_r11_qualification_execution_v1.replay import (
    read_csv_round_trip,
)
...
def test_role_worker_exposes_only_fixed_closed_commands() -> None:
    ...
    assert "r8_r11_qualification_execution_v1.protected_role" in source
    assert "r7_qualification_generation.protected_role" not in source


def test_r8_r11_uses_new_one_shot_paths_and_explicit_digest_contract() -> None:
    ...
    assert "r8_r11_qualification_activation_20260823" in custodian
    assert "qualification_activation_20260822" not in custodian
    assert 'PUBLIC_RUN_ID = "20260824T000002"' in runner
